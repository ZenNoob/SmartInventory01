...
async function run() {
  const tables = ['Products', 'Units', 'Categories', 'Sales', 'SalesItems', 'Customers', 'Suppliers', 'Purchases', 'PurchaseItems', 'Shifts', 'Users', 'Sessions', 'Stores', 'UserStores', 'Payments', 'CashFlow', 'Settings'];
